...
\definecolor{ugrColor}{HTML}{ed1c3e}
\definecolor{ugrColor2}{HTML}{c6474b}

% Datos de portada
\usepackage{titling} % Facilita los datos de la portada
\author{Nicolas Bourbaki} %\let\Author\@author
\date{\today} %\let\Date\@date
\title{Elementos de matemática} %\let\Title\@title
...
\ThisULCornerWallPaper{1}{pcmod4.pdf}
\maketitle
\tableofcontents
...
\bibliographystyle{alpha} % Selecciona un estilo de cita.
